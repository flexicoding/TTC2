...
internal static class TestHelper
{
    ...
    public static IEnumerable<Course> GetRealTestSet()
    {
        ...
        var b31 = Course("3b1", 3, ["Akst", "Amelie", "Clara", "Eliah", "Emma S", "Emma W", "Fenja", "Onyx", "Joshua", "Juliane", "Lea", "Lennard", "Marie-M", "Lotta", "Sofiia", "William"]);
        ...
        MustContain(PERSONS + 3, gk21, gk22, gk24, wi51);
        ...
        MustContain(PERSONS + 3 - 3, s21, s22, s23); // - Lotta - Eliah - Juliane
