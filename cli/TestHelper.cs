...
internal static class TestHelper
{
    ...
    public static IEnumerable<Course> GetRealTestSet()
    {
        ...
        var m52 = new Course("5M2", 5, ["Maier", "Jonathan", "Alexander", "Felix G", "Josef", "Lorenz", "Luka", "Moana", "Muhammed", "Violet", "William", "Eliah", "Fenja", "Lea", "Mara", "Serhii", "Lennard"]);
        var m31 = new Course("3m1", 3, ["Maier", "Anna", "Annabel", "Bruno", "Emma S", "Emma W", "Johanna", "Miriana", "Nola", "Elin", "Tabitha", "Juliane", "Katharina", "Lilly", "Marie-M", "Lisa"]);
        ...
        var rel21 = new Course("2rel1", 2, ["Droesch", "Johanna", "Tabitha", "Emma W", "Catelyn", "Alexander", "Katharina", "Matilda", "Miriana"]);
        ...
        var bk21 = new Course("2bk1", 2, ["Waidosch", "Jonathan", "Lorenz", "Bruno", "Nola", "Emma W", "Lennard", "Eliah", "Amelie", "Onyx", "Violet", "Lotta", "Sofiia"]);
        var bk22 = new Course("2bk2", 2, ["Waidosch", "Jaron", "Annabelle", "Anna", "Josef", "Matilda", "Muhammed", "Katharina", "Mara"]);
        ...
        var sp22 = new Course("2sp2", 2, ["Engel", "Pia", "Nola", "Luka", "Miriana", "Linyi", "Annabelle", "Luana", "Emma S", "Marie-M", "Katharina", "Annabel", "Lorenz", "William", "Lisa", "Catelyn", "Felix H", "Hendrik", "Richard", "Onyx", "Jonathan"]);
